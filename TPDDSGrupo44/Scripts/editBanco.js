$(document).ready(function () {
    ...
    var coordenada_Latitude, coordenada_Longitude, calle, numeroAltura, nombreDePOI, palabrasClave;
    ...
    $("input").not("#coordenada_Latitude").not("#coordenada_Longitude").not("#calle").
        not("#numeroAltura").not("#nombreDePOI").not("[name='palabrasClave']").on("blur", function () {
            validar();
        });
    ...
    function validar() {
        ...
        if (coordenada_Latitude && coordenada_Longitude && calle && numeroAltura && nombreDePOI && palabrasClave) {
